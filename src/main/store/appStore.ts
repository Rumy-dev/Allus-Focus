...
let state: AppSnapshot = {
  ...
  soundSplash: DEFAULT_PREFERENCES.soundSplash,
  soundFocusStart: DEFAULT_PREFERENCES.soundFocusStart,
  soundFocusEnd: DEFAULT_PREFERENCES.soundFocusEnd,
  soundBreakEnd: DEFAULT_PREFERENCES.soundBreakEnd,
  soundIdlePause: DEFAULT_PREFERENCES.soundIdlePause,
  ...
  floatingPanelPosition: DEFAULT_PREFERENCES.floatingPanelPosition,
